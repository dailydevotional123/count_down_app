...
class ActionCardWidget extends StatelessWidget {
  ...
  const ActionCardWidget({Key? key, required this.devotionalModel})
      : super(key: key);
      ...
      return Padding(
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text: devotionalModel!.action.toString(),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: () {
                            Share.share(
                              devotionalModel!.action.toString(),
                            );
                          },
                          child: Row(
                            children: [
                            ...
                            child: Container(
                              ...
                              child: Center(
                                  child: textToAudioProvider.ttsState.name ==
                                      ...
                                      : InkWell(
                                          onTap: () {
                                            textToAudioProvider.speakText(
                                                devotionalModel!.action
                                                    .toString());
                                          },
                                          child: const Icon(
                                            Icons.play_arrow,
            ...
            //                 color: AppColors.primaryColor),
            //             child: Center(
            //               child: SvgPicture.asset(ImageConstants.play),
            //             ),
            //           )
            //         ],
            //       ),
