...
class PrayerCardWidget extends StatelessWidget {
  ...
  const PrayerCardWidget({Key? key, required this.devotionalModel})
      : super(key: key);
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        children: [
                          TextSpan(
                              text: devotionalModel!.prayer.toString(),
                    ...
                    Row(
                      ...
                      children: [
                            ...
                            GoRouter.of(context).push(AddNoteScreen.route,
                                extra: {
                                  RouteConstants.scriptureText:
                                      devotionalModel!.scripture.toString()
                                });
                          },
                          child: Row(
                            children: [
                        ...
                        InkWell(
                          onTap: () {
                            Share.share(
                              devotionalModel!.prayer.toString(),
                            );
                          },
                          child: Row(
                            children: [
